    ...
    return (
        <section className="relative bg-soller-feedback md:bg-soller-purple overflow-hidden pt-20">
            <div className="relative flex flex-col justify-between md:flex-row ">
                <div className="flex flex-col w-full max-w-[1094px] md:pl-20 xl:pl-80 z-10">
                ...
                <div className="absolute lg:hidden bottom-[-400px] left-[-100px] md:top-[-650px] md:right-[-1800px]  z-0">
